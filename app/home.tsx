    ...
    <View className="flex flex-col">
      <View className="h-[50vh] bg-black flex justify-center items-center">
        <TouchableOpacity onPress={() => navigation.navigate("map")}>
          <View className="mt-[0px] ml-[80%] bg-white p-2 rounded-full">
            <Image
              source={{
                uri: "https://rjhiucwgtqbfccdwscfa.supabase.co/storage/v1/object/public/assets/location.png",
              }}
        ...
        <View className="mt-[50px] bg-white p-10 rounded-full"></View>
